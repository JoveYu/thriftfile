...
class Processor(Iface, TProcessor):
    ...
    def process_Add(self, seqid, iprot, oprot):
        ...
        result = Add_result()
        try:
            result.success = self._handler.Add(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except thriftfile.py.common.ttypes.Exception as e:
            msg_type = TMessageType.REPLY
            result.e = e
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.e = thriftfile.py.common.ttypes.Exception()
                    self.e.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
...
Add_result.thrift_spec = (
    ...
    (1, TType.STRUCT, 'e', [thriftfile.py.common.ttypes.Exception, None], None, ),  # 1
)
